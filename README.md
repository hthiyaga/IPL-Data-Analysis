...
Hovering the each bar will give exact number of wins. Even the teams in the dropdown selector are palced from highest to lowest number of wins.The third and final scatterplot shows the supporting factor for the previous two charts. If we look at the first and second 
